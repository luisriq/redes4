...
graficoAMMod(info, rate,500000, plots[0], pm=0.15,st=True, color = 'r', titulo = 'Señal AM modulada al 15%')
graficoAMMod(info, rate,500000, plots[1], pm=1.0,st=True, color = 'g', titulo = 'Señal AM modulada al 100%')
graficoAMMod(info, rate,500000, plots[2], pm=1.25,st=True, color = 'b', titulo = 'Señal AM modulada al 125%')
